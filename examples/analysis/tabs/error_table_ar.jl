...
function error_table_ar(country::String, ea, data, quarters, horizons;
    ...
    for k = 1:3
        ...
        create_bias_rmse_tables_var(forecast, actual, horizons, "training", "ar", number_variables, k, country; model_variant=model_variant)
    end
    return nothing
end